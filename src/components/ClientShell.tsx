    ...
    return (
        <>
            <a
                href="#main-content"
                title="跳到主要內容區"
                className="absolute left-2 top-2 -translate-y-full focus:translate-y-0 bg-white text-blue-700 font-semibold px-4 py-2 rounded shadow focus:outline-none focus:ring-2 focus:ring-blue-500 z-[9999]"
            >
                跳到主要內容
            </a>
